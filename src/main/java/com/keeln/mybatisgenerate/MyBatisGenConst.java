package com.keeln.mybatisgenerate;
...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.keeln.dal";
    public static final String DO_PACKAGE = "com.keeln.domain.model";
    public static final String QUERY_PACKAGE="com.keeln.domain.query";
    public static final String MAPPER_PACKAGE = "com.keeln.mapper";
    public static final String MANAGER_PACKAGE= "com.keeln.manager";
    public static final String MANAGER_IMPL_PACKAGE= MANAGER_PACKAGE+".impl";

    public static final String MAPPER_EXT_PACKAGE = "com.keeln.mapper.ext";
    ...
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "src/main/java/com/keeln/domain/model";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "src/main/java/com/keeln/domain/query";
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = WORK_DIR + "src/main/java/com/keeln/mapper";
    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "src/main/java/com/keeln/mapper/ext";

    public static final String MANAGER_JAVA_DIR = WORK_DIR + "src/main/java/com/keeln/manager";
    public static final String MANAGER_IMPL_JAVA_DIR =  MANAGER_JAVA_DIR +"/impl";



    // java数据对象类模板
    public static final String DO_TEMPLATE = ClassLoader.getSystemResource("template/do_v2.txt").getPath();//  "resources/template/do.txt";
    // query 模板
