...
public interface ApiDataMapper {
     ...
     * insert selective.
     */
    int insertSelective(ApiDataDO record);
     ...
     */
    int updateByQuerySelective(@Param("record") ApiDataDO record, @Param("query") ApiDataQuery query);

    /**
     * update by query condition.
     */
    int updateByQuery(@Param("record") ApiDataDO record, @Param("query") ApiDataQuery query);
