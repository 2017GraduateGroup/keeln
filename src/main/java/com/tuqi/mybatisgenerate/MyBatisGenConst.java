...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.tuqi.dal";
    public static final String DO_PACKAGE = "com.tuqi.domain.model";
    public static final String QUERY_PACKAGE="com.tuqi.domain.query";
    public static final String MAPPER_PACKAGE = "com.tuqi.mapper";
    public static final String MANAGER_PACKAGE= "com.tuqi.manager";
    public static final String MANAGER_IMPL_PACKAGE= MANAGER_PACKAGE+".impl";

    public static final String MAPPER_EXT_PACKAGE = "com.tuqi.mapper.ext";
    ...
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "src/main/java/com/tuqi/domain/model";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "src/main/java/com/tuqi/domain/query";
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = WORK_DIR + "src/main/java/com/tuqi/mapper";
    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "src/main/java/com/tuqi/mapper/ext";

    public static final String MANAGER_JAVA_DIR = WORK_DIR + "src/main/java/com/tuqi/manager";
