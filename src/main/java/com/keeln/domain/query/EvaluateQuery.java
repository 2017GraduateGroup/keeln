...
public class EvaluateQuery extends BaseQuery implements Serializable {
     ...
     */
        ...
        public Criteria andGmtCreatLike(Date value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("gmt_creat like", strValue, "gmtCreat");
            return (Criteria) this;
        }

        public Criteria andGmtCreatNotLike(Date value) {
            String strValue = "%"+value.toString()+"%";
            addCriterion("gmt_creat not like", strValue, "gmtCreat");
            return (Criteria) this;
        }
